...
import { Mail, Phone, MapPin, User, Clock, Send, Instagram, Twitter } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-stone-100">
              <h2 className="text-2xl font-serif text-stone-900 mb-8">Contact Info</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Manager</p>
                    <p className="text-stone-800 font-medium">NAMO BAI MEENA</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-stone-800 font-medium">harjimeena06@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Call Anytime</p>
                    <p className="text-stone-800 font-medium">+91 9982233323</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-stone-800 font-medium leading-relaxed">
                      80 Feet Rd, near MCM hospital, Shiv Nagar, Niwai,<br /> Rajasthan, 304021
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-stone-900 rounded-[2rem] p-8 text-white shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between border-b border-stone-800 pb-2">
                  ...
                  <span className="text-orange-500 font-medium">9am – 10pm</span>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-stone-100 h-full">
              <h3 className="text-3xl font-serif text-stone-900 mb-8">Send Us a <span className="text-orange-600">Message</span></h3>

              <form className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-stone-500 uppercase tracking-widest ml-1">Your Name</label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2 space-y-2">
                  <label className="text-xs font-bold text-stone-500 uppercase tracking-widest ml-1">Subject</label>
                  <select className="w-full px-6 py-4 rounded-2xl bg-stone-50 border-none focus:ring-2 focus:ring-orange-600/20 outline-none transition-all appearance-none cursor-pointer">
                ...
                <div className="md:col-span-2 space-y-2">
                  <label className="text-xs font-bold text-stone-500 uppercase tracking-widest ml-1">Message</label>
                  <textarea
                    rows={5}
